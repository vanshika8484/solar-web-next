...
const Diesel = () => {
  return (
    <>
      <div className="bg-gray-50 text-gray-800 font-sans py-20 -mt-20">
        <header className="text-center py-10">
          <h1 className="text-5xl font-bold">Genset Solutions</h1>
        </header>
      ...
      <section className="mt-[50px] mb-[-30px]">  <Footer /></section>
    </>
  );
};
